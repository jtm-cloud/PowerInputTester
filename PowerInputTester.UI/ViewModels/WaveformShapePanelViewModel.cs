...
{
    public class WaveformShapePanelViewModel : ViewModelBase, IInstrumentControlPanel
    {
        ...
        public WaveformShapePanelViewModel(string header, ICollection<WaveformShapeOptionsContainer> containers, string enabledReferenceName, InstrumentEventHandler handler)
        {
