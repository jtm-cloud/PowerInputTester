...
{
    public class CIPowerSupplyMockUp : IInstrument
    {
        #region Backing Fields

        private ICollection<string> _mainSettings;
        private InstrumentEventHandler _handler;

        #endregion
        public InstrumentInfo Info { get; set; }
        public CIPowerSupplySettingsMockUp Settings { get; set; }

        public CIPowerSupplyMockUp(InstrumentInfo info, InstrumentEventHandler handler)
        {
            Info = info;
            _handler = handler;
            _handler.OnUserInput += _handler_OnUserInput;
            _handler.OnAllSettingsRequested += _handler_OnAllSettingsRequested;
            Settings = new CIPowerSupplySettingsMockUp();
